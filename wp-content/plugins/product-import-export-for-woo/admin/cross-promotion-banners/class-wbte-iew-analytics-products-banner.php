...
if ( ! class_exists( 'Wbte_Iew_Analytics_Products_Banner' ) ) {
	...
	class Wbte_Iew_Analytics_Products_Banner {
		...
		private function get_variant_copy( $variant ) {
			if ( 'premium' === $variant ) {
				return array(
					'title'          => __( 'Go beyond basic product imports/exports.', 'product-import-export-for-woo' ),
					'body'           => __( 'Handle variable, subscription, and custom products, automate imports/exports, and map fields effortlessly with advanced features in the Pro version.', 'product-import-export-for-woo' ),
			...
			// 'suite' default.
			return array(
				'title'          => __( 'Still Managing Data in Pieces?', 'product-import-export-for-woo' ),
				'body'           => __( 'Import, export, and back up users, orders, products, coupons, and more without switching between multiple plugins. Manage it all with a single, unified workflow using Import Export Suite.', 'product-import-export-for-woo' ),
